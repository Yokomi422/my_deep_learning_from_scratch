...
class TwoLayerNet:
    def __init__(self, params: TwoLyNNParams):
        self.params = {
            "W1": params.weight_init_std
            * np.random.randn(params.input_size, params.hidden_size),
            "b1": params.weight_init_std * np.zeros(params.hidden_size),
            "W2": params.weight_init_std
            * np.random.randn(params.hidden_size, params.output_size),
        ...
        # TODO レイヤーの共通の型を作成する
        self.layers["Relu1"] = ReLuLayer()  # type: ignore
